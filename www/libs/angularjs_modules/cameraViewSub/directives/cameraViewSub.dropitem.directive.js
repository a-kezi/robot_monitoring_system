...
directive('cameraViewSubDropItem', ['$parse', '$rootScope', '$compile', 
    function() {
        return {
            restrict: 'A',
                ...
                $element.bind('drop', function(evt){
                    ...
                    switch(dropitem_id){
                        ...
                        case "cameraone":
                            ...
                            player = document.getElementById('videoOne');
                            break;
                        case "cameratwo":
                            $scope.cameraTwo_name = "["+data.camera.position+"]";
                            player = document.getElementById('videoTwo');
                            break;
                    }
